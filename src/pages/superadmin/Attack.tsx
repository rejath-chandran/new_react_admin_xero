...
import { fetchAttack } from "../../api/services/attack";
...
export const Attack = () => {
  ...
  const {
    ...
    queryKey: ["attacks", searchTerm],
    queryFn: () => fetchAttack(searchTerm),
    enabled: true,
  });
  ...
  return (
    <>
      ...
      <div className="flex flex-col sm:gap-4 sm:py-4 sm:pl-2">
       <Header name="Attacks" handleSearchChange={handleSearchChange} handleLogout={handleLogout} />
